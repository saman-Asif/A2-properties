...
const Navbar = () => {
  return (
    <>
      <div className='flex max-w-9xl h-16 mx-auto xl:px-20 p-4 md:py-4 justify-between items-center w-full bg-[#0e131d]'>
        <div className=''>
          <Link to='/'>
...
<button
 className='border-white/30 border p-1 rounded-md hover:border-purple-700 transition-colors duration-300 ease-in-out'>
     <Sun size={18} /> 
</button>
<Link to='/signin'><button className='text-white hidden md:block text-center font-bold hover:text-purple-700 hover:bg-white rounded-lg px-4 py-2.5'> 
  Sign in
</button></Link>
