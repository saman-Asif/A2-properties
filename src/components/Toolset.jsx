...
const Toolset = () => {
    ...
    return (
        <>
            <div className='w-full reveal-elements h-auto  bg-[#131926] md:px-16 py-16 md:py-20 border-b border-white/10 p-4'>
                ...
                <h1 class="text-4xl max-w-2xl md:text-5xl text-white font-bold tracking-tight mt-3 mb-10">
                    ...
                    {features.map((feature, index) => (
                        <div key={index} className='md:grid hover:bg-gray-900/70 md:grid-cols-[240px_1fr] items-center px-6 py-[18px] border-b border-white/[0.03] last:border-b-0 transition-colors'>
